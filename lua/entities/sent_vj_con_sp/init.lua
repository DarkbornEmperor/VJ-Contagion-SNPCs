...
ENT.EntitiesToSpawn = {
	...
	{EntityName = "NPC2",SpawnPosition = {vForward=0,vRight=50,vUp=0},Entities = {"npc_vj_con_zcarrier","npc_vj_con_zyumi","npc_vj_con_ztony","npc_vj_con_zriot","npc_vj_con_znick","npc_vj_con_zmia","npc_vj_con_zmarcus","npc_vj_con_zmanuel","npc_vj_con_zjessica","npc_vj_con_zeugene","npc_vj_con_zofficer","npc_vj_con_zlooter","npc_vj_con_zinmate","npc_vj_con_zcurtis","npc_vj_con_zdoc","npc_vj_con_zfemale","npc_vj_con_zcivi","npc_vj_con_zmale"}},
	{EntityName = "NPC3",SpawnPosition = {vForward=100,vRight=50,vUp=0},Entities = {"npc_vj_con_zcarrier","npc_vj_con_zyumi","npc_vj_con_ztony","npc_vj_con_zriot","npc_vj_con_znick","npc_vj_con_zmia","npc_vj_con_zmarcus","npc_vj_con_zmanuel","npc_vj_con_zjessica","npc_vj_con_zeugene","npc_vj_con_zofficer","npc_vj_con_zlooter","npc_vj_con_zinmate","npc_vj_con_zcurtis","npc_vj_con_zdoc","npc_vj_con_zfemale","npc_vj_con_zcivi","npc_vj_con_zmale"}},
	{EntityName = "NPC4",SpawnPosition = {vForward=100,vRight=-50,vUp=0},Entities = {"npc_vj_con_zcarrier","npc_vj_con_zyumi","npc_vj_con_ztony","npc_vj_con_zriot","npc_vj_con_znick","npc_vj_con_zmia","npc_vj_con_zmarcus","npc_vj_con_zmanuel","npc_vj_con_zjessica","npc_vj_con_zeugene","npc_vj_con_zofficer","npc_vj_con_zlooter","npc_vj_con_zinmate","npc_vj_con_zcurtis","npc_vj_con_zdoc","npc_vj_con_zfemale","npc_vj_con_zcivi","npc_vj_con_zmale"}},
	{EntityName = "NPC5",SpawnPosition = {vForward=0,vRight=-50,vUp=0},Entities = {"npc_vj_con_zcarrier","npc_vj_con_zyumi","npc_vj_con_ztony","npc_vj_con_zriot","npc_vj_con_znick","npc_vj_con_zmia","npc_vj_con_zmarcus","npc_vj_con_zmanuel","npc_vj_con_zjessica","npc_vj_con_zeugene","npc_vj_con_zofficer","npc_vj_con_zlooter","npc_vj_con_zinmate","npc_vj_con_zcurtis","npc_vj_con_zdoc","npc_vj_con_zfemale","npc_vj_con_zcivi","npc_vj_con_zmale"}},
}
/*-----------------------------------------------
	*** Copyright (c) 2012-2019 by DrVrej, All rights reserved. ***
	No parts of this code or any of its contents may be reproduced, copied, modified or adapted, 
